...
const AccountingExpert = () => {
  return (
    <div>
      ...
      <Title2>Важно!</Title2>
      <Description>
        Несудебной экспертиза считается тогда, когда она назначается по
      ...
      <Title>Цель бухгалтерской экспертизы</Title>
      <Description>
      ...
      <Title2>Важно!</Title2>
      <Description>
        Предотвратить большинство проблем, связанных с состоянием бухгалтерских
