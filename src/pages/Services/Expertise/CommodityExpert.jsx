    ...
    <div>
      ...
      <Ul>
        <li>
          ...
          кондитерские изделия, молочные продукты, алкогольные, слабоалкогольные
          и безалкогольные напитки, чай, кофе;
        </li>
      ...
      <Ul>
        ...
        <li>
          Органолептический – выявление характерных свойств объекта по признакам
      ...
      <Ul>
        <li>
          Имеется ли факт нарушения, в ходе выполнения экспертного исследования,
          установленных стандартов качества и нормативам?
        </li>
        <li>
