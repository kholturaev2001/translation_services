...
const LiteraryTranslation = () => {
  return (
    <div>
      ...
      <Description>
        Если вы намерены заказать перевод книги в бюро переводов ООО
        АИС«ПЕРЕВОДЧИК», можете полностью нам довериться. Ведь за нашими плечами
        более 9 лет успешной работы и сотни довольных сотрудничеством клиентов.
      </Description>
      <Description>
