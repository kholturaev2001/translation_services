...
const data = [
  {
    image: img6,
    title: "Надежность и профессионализм в каждой оценке!",
  },
  {
    image: img2,
    title: "Мы делаем ценностное видимым: оценка недвижимости, бизнеса и многое другое.",
  },
  {
    image: img3,
    title: "Экспертная оценка для вашего успеха.",
  },
  {
    image: img4,
    title: "Мы оцениваем, вы принимаете решения.",
  },
  {
    image: img5,
    title: "С нами ваше имущество всегда в надежных руках.",
  },
  {
    image: img7,
    title: "Качественная оценка для вашего спокойствия.",
  },
];
...
const Main = () => {
  ...
  /* 
"Надежность и профессионализм в каждой оценке!"
"Мы делаем ценностное видимым: оценка недвижимости, бизнеса и многое другое."
"Экспертная оценка для вашего успеха."
"Оценка - ключ к правильным решениям."
"Мы оцениваем, вы принимаете решения."
"Оценка с точностью и доверием."
"Экспертиза, которой можно доверять: судебная, техническая, финансовая."
"Качественная оценка для вашего спокойствия."
"Мы оцениваем будущее сегодня."
"С нами ваше имущество всегда в надежных руках."
  */
